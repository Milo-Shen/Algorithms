...
function partition_array(colors, start, end, color_start, color_end) {
  ...
  let mid_color = Math.floor((color_start + color_end) / 2);
  ...
  partition_array(colors, left, end, mid_color + 1, color_end);
}

console.log(sort_colors2([3, 2, 3, 3, 4, 3, 3, 2, 4, 4, 1, 2, 1, 1, 1, 3, 4, 3, 4, 2], 4));
